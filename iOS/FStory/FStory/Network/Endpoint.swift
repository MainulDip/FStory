...
enum Endpoint {
    case validateLoginRequest(url: String = "/login", credential: UserLoginCredential)
    ...
    private var path: String {
        ...
        case .validateLoginRequest(let url, _):
            return url
        }
    }
    ...
    private var httpMethod: String {
        ...
        case .sendPost, .validateLoginRequest:
    ...
    private var httpBody: Data? {
        ...
        case .sendPost( _, let post ):
            ...
            return jsonPost
        case .validateLoginRequest(_, credential: let credential):
            let jsonCredential = try? JSONEncoder().encode(credential)
